...
NeuralNetworkOptimizer::NeuralNetworkOptimizer( Config* settings ) : OptimizerBase( settings ) {
    ...
    std::vector<std::string> input_name_1_models = {
        "Harmonic_Mk11_M2_2D",        "Harmonic_Mk11_M2_2D_gamma1", "Harmonic_Mk11_M2_2D_gamma2", "Harmonic_Mk11_M2_2D_gamma3",
        "rot_Harmonic_Mk11_M1_2D",        "rot_Harmonic_Mk11_M1_2D_gamma1", "rot_Harmonic_Mk11_M1_2D_gamma2", "rot_Harmonic_Mk11_M1_2D_gamma3",
