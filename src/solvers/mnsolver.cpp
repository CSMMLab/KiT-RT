...
#pragma omp parallel for
    for (unsigned idx_group = 0; idx_group < nGroups; idx_group++)
    {
        ...
        case ANALYTIC:
            ...
            break;
        default:
            ErrorMessages::Error("Volume Output Group not defined for MN Solver!", CURRENT_FUNCTION);
            break;
        }
    }
}
...
double MNSolver::GetCurrentOutflow()
{
    return 0.0;
}

double MNSolver::GetTotalOutflow(unsigned iteration)
{
    if (iteration == 0)
    {
...
double MNSolver::GetMaxOutflow() { return 0; }
...
double MNSolver::GetTotalAbsorptionVertical() { return 0; }
