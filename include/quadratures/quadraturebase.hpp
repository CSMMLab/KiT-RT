...
public:
  ...
  inline VectorVector &GetPoints() { return _pointsKarth; } /*! @returns VectorVector _points:  coordinates of gridpoints of the quadrature */
  inline VectorVector &GetPointsSphere()
  {
